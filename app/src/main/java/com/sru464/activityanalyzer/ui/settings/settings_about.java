...
public class settings_about extends Fragment {
    ...
    public static settings_about newInstance(String param1, String param2) {
        settings_about fragment = new settings_about();
